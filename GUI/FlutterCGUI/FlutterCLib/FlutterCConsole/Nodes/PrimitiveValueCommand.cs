...
{
    public abstract class PrimitiveValueCommand : Command
    {
        public PerformDelegate operation;
        public Value res;

        public Value copyA = new Value("int", false);

        public bool withAssignment = false;

        public abstract void setOperation();

        public void setWithAssignment()
        {
            withAssignment = true;
        }
        ...
        public override void execute()
        {
            ...
            if(!withAssignment){
                Memory.instance.push(res);
            }
            else
            {
                Assignment.assignTo(b, res);
